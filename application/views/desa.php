        ...
        <table id="user_data" class="table table-bordered table-striped">  
          ...
          <?php foreach ($desa as $d) { ?>  
              <tr>
                ...
                <td>
                  <a class="btn btn-success float-left ml-1" href="<?= base_url()."controller/ubahdesa"?>">Ubah</a>
                  <a class="btn btn-danger float-left ml-1" href="<?= base_url()."controller/hapus_data/".$d['id_destana'];?>" onclick="return confirm('Anda Yakin Ingin Menghapus Data Ini?')">Hapus</a>
                </td>
              </tr>
              <?php } ?>
            </table>  
