...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg fixed-top navbar-dark home">
    <div class="container">
      <a class="navbar-brand" href="<?= base_url()."controller"; ?>">HORIZON</a>
      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon"></span>
      </button>
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav ml-auto">
          <a class="nav-item nav-link active" href="<?= base_url()."controller"; ?>">Home <span class="sr-only">(current)</span></a>
          ...
          <a class="nav-item nav-link active" href="<?php echo base_url()."controller/login"; ?>">Login</a>
          <a class="nav-item nav-link active" href="<?php echo base_url()."controller/register"; ?>">Register</a>
        </div>
      </div>
    </div>  
  </nav>